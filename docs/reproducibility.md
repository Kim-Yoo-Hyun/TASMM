...
- Reproduction-critical scripts and docs are not ignored: E005 bridge/repair scripts, E007 path-cost bridge scripts, E008 navigation scripts through `plan_m45_source_diverse_redesign_trajectory_contract.py` and `run_m46_source_diverse_redesign_trajectory_execution_smoke.py`, `README.md`, `TODO.md`, and this document are visible to git.
