...
현재 연구 제약은 6개월~1년 규모로 둔다. 최종 목표는 top-tier full paper이며, 중간에 독립적인 contribution이 성립하면 workshop, short paper, 또는 관련 venue에 먼저 투고할 수 있다.
...
- top-tier 제출을 목표로 하되, venue별 양식보다 먼저 "강한 주장 + 재현 가능한 증거 + 명확한 한계"를 만든다.
...
- Current E003 status: M00-M28 cap-aware label-balanced detector policy smoke complete; next is E003-M29 Docker pre-cap policy integration rerun gate.
- Current boundary: main experiment implementation 단계이며, paper 폴더는 아직 만들지 않는다.
- Current top-tier path: E001 benchmark/proxy -> E002 search/navigation bridge -> E003 controlled perception/proposal noise -> Dockerized RGB-D/open-vocabulary proposal route -> E004 task-context memory trust / re-observation decision.
