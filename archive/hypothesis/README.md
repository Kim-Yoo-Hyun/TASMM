...
Status: archived hypothesis-stage workspace. H001 main experiment transition has been accepted; active implementation is now in `experiments/E008_real_navigation_benchmark/`.

This folder is kept for audit and claim-boundary history. Do not treat it as the active execution path.
