...
- Input prediction rows: 3407
- Evaluated scans: 8 / 8
- Scan-level evaluation target rows: 344
- Label-overlap target rows: 343
- Matched proposal rows: 198
- Matched target rows: 198
- Proposal precision smoke: 0.05811564426181391
- Scan target recall smoke: 0.5755813953488372
- Label-overlap target recall smoke: 0.577259475218659
- False-positive proposal rows: 3209
- Mean matched centroid error m: 0.5447731414141415
