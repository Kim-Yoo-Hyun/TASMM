...
- Input prediction rows: 24
- Evaluated scans: 1 / 8
- Scan-level evaluation target rows: 51
- Label-overlap target rows: 23
- Matched proposal rows: 1
- Matched target rows: 1
- Proposal precision smoke: 0.041666666666666664
- Scan target recall smoke: 0.0196078431372549
- Label-overlap target recall smoke: 0.043478260869565216
- False-positive proposal rows: 23
- Mean matched centroid error m: 0.916258
