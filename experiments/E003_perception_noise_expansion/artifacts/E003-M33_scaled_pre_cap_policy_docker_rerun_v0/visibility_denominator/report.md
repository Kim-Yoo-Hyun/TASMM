...
- Evaluated scans: 8
- Evaluated frames: 192
- Scan-level evaluation target rows: 344
- Active M22 prompt target rows: 344
- Prompt-not-active target rows: 0
- Centroid frustum-visible target rows: 211
- Depth-valid projected target rows: 180
- Depth-consistent visible-proxy target rows: 154
- M22 matched target rows: 204
- M23 selected matched target rows: 204
- M22 matched outside centroid frustum proxy rows: 32
- Detector/threshold missed depth-consistent visible target rows: 13
- M22 recall over scan denominator: 0.5930232558139535
- M22 recall over active prompt denominator: 0.5930232558139535
- M22 recall over depth-consistent visible proxy denominator: 0.9155844155844156
- M23 recall over depth-consistent visible proxy denominator: 0.9155844155844156
