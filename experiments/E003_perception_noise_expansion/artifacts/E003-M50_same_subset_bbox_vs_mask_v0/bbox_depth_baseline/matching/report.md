...
- Input prediction rows: 31
- Evaluated scans: 1 / 8
- Scan-level evaluation target rows: 51
- Label-overlap target rows: 30
- Matched proposal rows: 2
- Matched target rows: 2
- Proposal precision smoke: 0.06451612903225806
- Scan target recall smoke: 0.0392156862745098
- Label-overlap target recall smoke: 0.06666666666666667
- False-positive proposal rows: 29
- Mean matched centroid error m: 0.5913555
