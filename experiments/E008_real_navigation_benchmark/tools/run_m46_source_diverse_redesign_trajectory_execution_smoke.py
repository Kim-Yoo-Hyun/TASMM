#!/usr/bin/env python3
"""Execute E008-M44 source-diverse redesign rows as an E008-M46 trajectory smoke."""
...
VERSION = "e008_m46_source_diverse_redesign_trajectory_execution_smoke_v0"
READY_STATUS = "e008_m46_source_diverse_redesign_trajectory_execution_smoke_ready"
BLOCKED_STATUS = "e008_m46_source_diverse_redesign_trajectory_execution_smoke_blocked"
NEXT_UNIT = "E008-M47 source-diverse redesign result interpretation and scale decision"

DEFAULT_M44_CONTRACT = EXP_ROOT / "artifacts" / "E008-M44_source_diverse_redesign_row_materialization_smoke_v0"
DEFAULT_ARTIFACT_DIR = EXP_ROOT / "artifacts" / "E008-M46_source_diverse_redesign_trajectory_execution_smoke_v0"
DEFAULT_DATA_OUT_DIR = ROOT / "local_dataset" / "HM3D_navigation_bridge" / "E008-M46_source_diverse_redesign_trajectory_execution_smoke_v0"
...
def build_claim_boundary_rows(ready: bool) -> list[dict[str, Any]]:
    return [
        {
            "version": VERSION,
            "claim_id": "source_diverse_redesign_trajectory_smoke",
            "supported": ready,
            "claim_boundary": "M46 executes the M44 source-diverse redesign rows in Habitat as a smoke test.",
        },
        {
            "version": VERSION,
            "claim_id": "final_real_navigation_sr_spl",
            "supported": False,
            "claim_boundary": "M46 is still a tiny controlled HM3D ObjectNav smoke; final navigation claim requires scale and stronger navigation/search baselines.",
        },
        {
            "version": VERSION,
...
def build_route_decision_rows(ready: bool) -> list[dict[str, Any]]:
    return [
        {
            "version": VERSION,
            "decision": "interpret_source_diverse_trajectory_result" if ready else "repair_m46_runner",
            "selected_next_unit": NEXT_UNIT if ready else "repair E008-M46 source-diverse trajectory execution smoke",
...
def build_report(coverage: dict[str, Any], aggregate_rows: list[dict[str, Any]], pairwise_rows: list[dict[str, Any]]) -> str:
    ...
    return "\n".join(
        [
            "# E008-M46 Source-Diverse Redesign Trajectory Execution Smoke",
            "",
            ...
            "## Claim Boundary",
            "",
            "- M46 is a source-diverse trajectory smoke, not a final navigation benchmark.",
...
def main() -> None:
    ...
    m37.DEFAULT_M36_CONTRACT = DEFAULT_M44_CONTRACT
